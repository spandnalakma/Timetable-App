...
export class AppService {
  ...
  test():Observable<any>{
    return this.http.get<any>("/api/secure");
  }
  ...
  getSubjectandCourseCodePairs():Observable<any>{
    return this.http.get<any>("/api/secure/courses").pipe(
      catchError(this.handleError<any>('getSubjectandCourseCodePairs',[]))
    )
  }

  createCourses(resObj):Observable<any>{
    return this.http.post<any>("/api/secure/schedules/create",resObj,this.httpsOptions).pipe(
  ...
  deleteCourseList(name:string):Observable<any>{
    ...
    return this.http.delete<any>(deleteUrl,this.httpsOptions).pipe(
  ...
  updateUserCoursList(name,resObj):Observable<any>{
    ...
    return this.http.put<any>(updateUrl,resObj,this.httpsOptions).pipe(
  ...
  createReview(resObj):Observable<any>{
    ...
    return this.http.post<any>(url,resObj,this.httpsOptions).pipe(
  ...
  getUsers():Observable<any>{
    return this.http.get<any>("/api/admin/userslist").pipe(
  ...
  updateUserStatus(username, resObject):Observable<any>{
    ...
    return this.http.put<any>(url,resObject,this.httpsOptions).pipe(
